...
class NumbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create number" do
    assert_difference("Number.count") do
      post numbers_url, params: { number: { name: @number.name, phone1: @number.phone1, phone2: @number.phone2, phone3: @number.phone3 } }
    end
  ...
  test "should update number" do
    patch number_url(@number), params: { number: { name: @number.name, phone1: @number.phone1, phone2: @number.phone2, phone3: @number.phone3 } }
